...
w = './yolov7_room_detector_v10.trt'
device = torch.device('cuda:0')
img = cv2.imread('/yolov7/inference/images/test_xav1.jpg')
...
names = ['face', 'person', 'chair', 'bed', 'bicycle', 'motorcycle', 'vehicle', 'bird', 'cat', 'dog',
         'fall', 'masque', 'incorrect mask', 'no mask', 'toothbrush']
...
img_final.save('/yolov7/test_xav_trt.jpg')
